...
su - vagrant -c 'cd /home/vagrant; curl -Lo- https://raw.githubusercontent.com/carlhuda/janus/master/bootstrap.sh | bash'
...
su - root -c 'cd /root; curl -Lo- https://raw.githubusercontent.com/carlhuda/janus/master/bootstrap.sh | bash'
